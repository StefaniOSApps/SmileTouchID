...
- (void)viewDidLoad {
    ...
    switch ([SmileAuthenticator sharedInstance].securityType) {
        ...
        case INPUT_THREE:
            self.touchIDButton.hidden = NO;
            self.navigationItem.title = [SpracheSmile by:@"SMILE_INPUT_THREE_TITLE"];
...
-(void)passwordWrong{
    ...
    self.descLabel.text = [NSString stringWithFormat:[SpracheSmile by:@"SMILE_INPUT_FAILED"], (long)_failCount];
}
...
@implementation SpracheSmile : NSObject
